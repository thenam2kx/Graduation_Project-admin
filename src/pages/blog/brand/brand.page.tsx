...
const handleNameChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "avatar",
      key: "avatar",
      render: (avatar: string) => (avatar ? <img src={avatar} alt="avatar" style={{ width: 50, height: 50, objectFit: "cover", borderRadius: 4 }} /> : <span>Không có ảnh</span>),
    },
    {
      title: "Trạng thái",
      dataIndex: "isPublic",
    ...
    },
    {
      ...
      render: (record: IBrand) => (
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          ...
          <Popconfirm title="Xóa thương hiệu" description="Bạn có chắc chắn muốn xóa thương hiệu này?" okText="Đồng ý" cancelText="Không đồng ý" onConfirm={() => handleDelete(record._id)}>
            <Tooltip title="Xóa">
              <Button danger>
                <DeleteFilled />
              </Button>
      ...
      >
        ...
        >
          ...
          <Form.Item label="Ảnh đại diện">
            ...
            {image && <img src={image} alt="Uploaded" className="mt-2 w-32 h-32 object-cover rounded" style={{ display: "block", margin: "0 auto", width: "350px", height: "350px" }} />}
          </Form.Item>
          ...
          <Form.Item name="isPublic" label="Trạng thái" rules={[{ required: true, message: "Vui lòng chọn trạng thái" }]}>
